...
$this->model_setting_setting->editSetting('payment_kanipay', $this->request->post);
...
'href' => $this->url->link('common/dashboard', 'user_token=' . $this->session->data['user_token'], true)
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/kanipay', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['action'] = $this->url->link('extension/payment/kanipay', 'user_token=' . $this->session->data['user_token'], true);
    ...
    $data['order_statuses'] = $this->model_localisation_order_status->getOrderStatuses();
     if (isset($this->request->post['payment_kanipay_status'])) {
      $data['payment_kanipay_status'] = $this->request->post['payment_kanipay_status'];
} else {
$data['payment_kanipay_status'] = $this->config->get('payment_kanipay_status');
}
	$data['header'] = $this->load->controller('common/header');
	$data['column_left'] = $this->load->controller('common/column_left');
	$data['footer'] = $this->load->controller('common/footer');
    $this->response->setOutput($this->load->view('extension/payment/kanipay', $data));
  }
}
