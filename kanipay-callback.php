...
$merchant=json_decode(file_get_contents("merchant.txt"),true);
 ?>
</head>
<body>
...
$new=array("timestamp"=>$_POST["time"],"customerid"=>"x","type"=>"purchase","amount"=>$_POST["pay"],"balance"=>$merchant["balance"]+$_POST["pay"]);
$merchant["balance"]+=$_POST["pay"];
array_push($merchant["table"],$new);
file_put_contents("merchant.txt",json_encode($merchant));
